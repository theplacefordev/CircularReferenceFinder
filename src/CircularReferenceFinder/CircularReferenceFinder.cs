...
namespace CircularReferenceFinder
{
    public static class CircularReferenceFinder 
    {
        ...
        public static IList<CircularReference> FindCycles(object root)
        {
            ...
            depthFirstSearch(root, new List<object>(), new ConditionalWeakTable<object, ObjectState>(), cycles);
            return cycles;
        }
        ...
        {
            // Note: following code intentionally doesn't ignore all value-type types, since custom structures may has reference type based properties
